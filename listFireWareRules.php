...
for($i=0; $i<$num; $i++){ 
  ...
  <td style="width:25%"><input type='button' class='button2' value='조회' onclick="portForwarding('<?=$i?>')"/></td>
  <td style="width:25%"><input type='button' class='button2' value='등록' onclick="addPortForwarding('<?=$i?>')"/></td>
