	...
	<div class="container-fluid">
		<div class="row-fluid" >
			<div class="span7"  >
				<h5>NAS볼륨 검색하기</h5>
				<form>
					<div id='searchnasdiv'class="custom-search-input">
						<select id='zonename'>
						...
						<input type="text" class="input-medium search-query" placeholder="검색할 NAS명을  입력해 주세요." disabled/>
						<span class="input-group-btn">
							<button id='searchnasbtn' type="button">
...
$( 
		function (){
			...
			$('#searchnasbtn').click(
					function(){//asdf
						zoneid = $('#searchnasdiv #zonename option:selected').val(); 
 
						if(zoneid=='all'){
							window.location.href = '/naslist';
						}else{ 
							window.location.href = '/naslist/showSearchResult/'+zoneid;	 
						} 
					}
			);
...
//							alert(count); 
					...
					error : function( ){ 
						alert('listcifsAccounts CifsAccount정보 가져오기 실패');
					}
				}); //ajax
			}
